...
Relational data base management system is what contains all of our databases/structures. SQL is the language we use to interact with it.

1. Why do tables need a `primary key`?

To ensure that there aren't identical values across different rows
...
a third table to uses multiple foreign keys
